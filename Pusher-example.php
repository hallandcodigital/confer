...
class PusherInstance {
	...
	private static $app_id	= ''; // Add app_id here
	private static $secret	= ''; // Add secret here
	private static $api_key = ''; // Add api_key here
	...
	public static function get_pusher()
	{
		...
		$options = array(
		    'cluster' => '', // set your Pusher app cluster, mine was 'ap1'
		    'encrypted' => true // have not tested setting to false
		  );
...
class Pusher
{
	 ...
	 */
	public function __construct( $auth_key, $secret, $app_id, $options = array(), $host = 'pusher-cluster-host-here', $port = 80, $timeout = 30, $debug = true ) // I had to set the $host varable here to 'api-ap1.pusher.com' I am not 100% sure of the DNS names for pushers other regional host endpoints so just left it static
	{
